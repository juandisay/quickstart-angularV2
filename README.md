...
[![Build Status](https://travis-ci.com/juandisay/quickstart-angularV2.svg?branch=main)](https://travis-ci.com/juandisay/quickstart-angularV2)
...
**Verify that you are running at least node `v8.x.x` and npm `6.13.4`**
